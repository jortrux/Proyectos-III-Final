  ...
  return (
    <main className="md:bg-gray-200 md:w-screen md:h-screen md:flex md:justify-center">
      <div className="bg-white md:rounded-xl md:h-auto flex-col self-center justify-center items-center gap-8 flex">
        <div className="md:m-10 flex-col flex">
          <div className="flex space-x-4 mx-2 md:mx-0 mt-5 md:mt-0">
            <Image src={backArrow} width={32} height={32} alt="Esto no furula" className="box-content h-8 w-8 self-center md:self-start md:hidden"></Image>
          ...
          <div className="flex gap-3 mt-2 md:justify-center mx-3 md:mx-0">
            <div className="w-full md:w-60 bg-gray-200 rounded-full h-2.5 mb-4 dark:bg-gray-700"></div>
            <div className="w-full md:w-60 bg-blue-600 h-2.5 rounded-full dark:bg-blue-500"></div>
            <div className="w-full md:w-60 bg-gray-200 rounded-full h-2.5 mb-4 dark:bg-gray-700"></div>
          </div>
          <div >
          ...
          <div className="grid justify-center md:grid-cols-2">
            <div className="grid justify-center md:col-start-1">
              <Image src={profileTemp} width={128} height={128} alt="Esto no furula" className="md:w-36 md:h-36 box-content justify-self-center col-start-1 row-start-1"></Image>
