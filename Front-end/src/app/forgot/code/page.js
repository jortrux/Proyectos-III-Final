              ...
              <div className="flex space-x-2">
                {codes.map((code, index) => (
                  <input
                    ...
                    className={error ? "w-12 h-12 md:h-16 text-center text-3xl font-Montserrat text-red-500 font-bold border-2 border-red-500 md:border-blue-500 rounded focus:outline-none" : "w-12 h-12 md:h-16 text-center text-3xl font-Montserrat text-gray-600 font-bold border-2 border-gray-400 md:border-blue-500 rounded focus:outline-none"}
                  />
                ))}
              </div>
            </div>
