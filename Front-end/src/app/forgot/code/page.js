        ...
        <div className="md:m-20 flex-col flex">
          ...
          <div className="my-12">
            ...
            <div className="flex justify-center">
              ...
              <path d="M14.9875 33C14.6042 33 14.3208 32.8333 14.1375 32.5C13.9542 32.1667 13.9542 31.8333 14.1375 31.5L23.3875 15.5C23.5708 15.1667 23.8625 15 24.2625 15C24.6625 15 24.9542 15.1667 25.1375 15.5L34.3875 31.5C34.5708 31.8333 34.5708 32.1667 34.3875 32.5C34.2042 32.8333 33.9208 33 33.5375 33H14.9875ZM24.2625 22C23.9792 22 23.7418 22.0957 23.5505 22.287C23.3585 22.479 23.2625 22.7167 23.2625 23V26C23.2625 26.2833 23.3585 26.5207 23.5505 26.712C23.7418 26.904 23.9792 27 24.2625 27C24.5458 27 24.7835 26.904 24.9755 26.712C25.1668 26.5207 25.2625 26.2833 25.2625 26V23C25.2625 22.7167 25.1668 22.479 24.9755 22.287C24.7835 22.0957 24.5458 22 24.2625 22ZM24.2625 30C24.5458 30 24.7835 29.904 24.9755 29.712C25.1668 29.5207 25.2625 29.2833 25.2625 29C25.2625 28.7167 25.1668 28.4793 24.9755 28.288C24.7835 28.096 24.5458 28 24.2625 28C23.9792 28 23.7418 28.096 23.5505 28.288C23.3585 28.4793 23.2625 28.7167 23.2625 29C23.2625 29.2833 23.3585 29.5207 23.5505 29.712C23.7418 29.904 23.9792 30 24.2625 30Z" fill="#14192C"/>
              </svg>
              <p className="text-red-500 text-xs font-light">El código introducido es incorrecto. Por favor, vuelve a introducirlo.</p>
            </div>
